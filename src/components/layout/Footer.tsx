          ...
          <div className="text-center sm:text-left">
            <h3 className="font-serif text-2xl font-bold text-white sm:text-3xl lg:text-4xl">
              ...
              <a
                ...
                className="underline decoration-purple/30 underline-offset-4 transition-colors hover:text-purple-light"
              >
                {EVENT.location}
              </a>
            </h3>
            <p className="mt-2 text-sm font-medium uppercase tracking-[0.2em] text-purple-light">
              {EVENT.motto}
            </p>
          </div>
          <Image
            ...
            <ul className="space-y-3">
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-white/60 transition-colors hover:text-purple-light"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              <li className="flex items-center gap-2">
                <svg className="h-4 w-4 shrink-0 text-purple-light" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
